...
# ESSE SCRIPT PRECISA TER O ENDERCO ({PRIVATE INFORMATION}\DATA1$\BR-SPL) MAPEADO NO COMPUTADOR PARA FUNCIONAR CORRETEMENTE
...
#CRIE A PASTA DO ANO DO PROJETO MANUALMENTE E APLIQUE PERMISSAO DE SOMENTE LEITURA PARA O GRUPO =  {PRIVATE INFORMATION}\AMS_BR-SPL_GROUPS_PM_PROJXX_RO
#APLICAR PERMISSAO SOMENTE A PASTA ATUAL UTILIZANDO AS OPÇOES AVANCADAS

$Local = "{PRIVATE INFORMATION}\DATA1$\BR-SPL\Groups\PM\PROJ16"

#NOME DO PROJETO PASSADO POR PARAMETRO
